...
require "../cgi-bin/generateHTMLClosedBusiness.pl";
...
if ( $admin_hash eq $uid or "2cff49e7376ab1b303b40e5e66c3795a" eq  $uid or "23f83ef1ed40e8cf5e7184591640e4aa" eq $uid )
{
...
$PG_COMMAND = "select * from messages2 INNER JOIN users3 ON (messages2.username = users3.id)  where messages2.status > \'0\' and messages2.username != \'$admin_hash\' and messages2.buyerid != \'$admin_hash\' ";
...
generateHTMLClosedBusiness( $sth, $sid, "viewOnly", $page_num );
