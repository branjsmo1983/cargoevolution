...
<!--===============================================================================================-->
  ...
  <body>
		...
		<div class="col-md-auto"> -->
			<div class="collapse navbar-collapse" id="navbarResponsive">
			  <ul class="navbar-nav ml-auto">
			    ...
			    <li class="nav-item">
			      <a class="nav-link" href="#works">Leggi i posti di lavoro disponibili</a>
			    </li>
			    <li class="nav-item">
			      <a class="nav-link" href="#people">Cerca tra i lavoratori disponibili</a>
			    </li>
			  </ul>
			</div>
		</div>
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('/mercatino/img/camionStradaBN.jpg')">
	<a name="header"></a>
        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="site-heading">
              <h1>Cerco/Offro Lavoro</h1>
              <span class="subheading">Sezione dedicata a chi cerca lavoro o a chi cerca personale specializzato e non</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container ">
      <div class="row">
        ...
        <div class="col-lg-8 col-md-10 mx-auto">
			...
			<form id="mercatinoForm" name="mercatinoForm" action="/cgi-bin/insertMercatino.pl" method="post" accept-charset="utf-8" enctype="multipart/form-data"  class="contact100-form validate-form container-contact100">
				<span class="contact100-form-title">
					$companyName , inserisci i dati per offrire lavoro o per offrirti come lavoratore
				...
				<div class="wrap-input100 input100-select bg1">
					<span class="label-input100" id="js-service-parent">Che tipologia di candidatura ?</span>
					<div class="js-select-parent" id="js-select-parent">
						<select class="js-select2" id="js-select2" name="service">
							...
							<option value ="1">Cerco Lavoro - Mi offro come Lavoratore</option>
							<option value ="2">Cerco Dipendente/Socio - Offro Lavoro </option>
						</select>
				...
				<div class="w-full dis-none js-show-service">
					<div class="wrap-contact100-form-radio">
						...
						<div class="contact100-form-radio m-t-15">
							<input class="input-radio100" id="radio1" type="radio" name="type-product" value="Autista" checked="checked">
						...
						<div class="contact100-form-radio">
							<input class="input-radio100" id="radio2" type="radio" name="type-product" value="Disponente al traffico">
							<label class="label-radio100" for="radio2">
								Disponente al traffico
							</label>
						</div>

						<div class="contact100-form-radio">
							<input class="input-radio100" id="radio3" type="radio" name="type-product" value="Magazziniere">
							<label class="label-radio100" for="radio3">
								Magazziniere
							</label>
						</div>
						<div class="contact100-form-radio">
							<input class="input-radio100" id="radio4" type="radio" name="type-product" value="Segertaria/o">
							<label class="label-radio100" for="radio4">
								Segretaria/o
							</label>
						</div>
						<div class="contact100-form-radio">
							<input class="input-radio100" id="radio5" type="radio" name="type-product" value="Impiegato/a commerciale">
					...
					<div class="wrap-contact100-form-range">
						<span class="label-input100">Stipendio *</span>
				...
				<div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate = "Per cortesia, compila questo campo con la tua lettera di presentazione oppure con delle note/precisazioni sui campi compilati in precedenza">
					<span class="label-input100">Lettera di presentazione *</span>
		...
		<div class="col-lg-8 col-md-10 mx-auto">
			<a name="works"></a>
			<h1 class="post-preview post-title">Cerca il lavoro che fa per te</h1></a><br>
...
my $dbh = DBI->connect("DBI:Pg:dbname=$database_name", "$db_username", "$db_pwd")
       or die $DBI::errstr;
  my $PG_COMMAND="select DISTINCT data, message, name, uid, cv, email, telephone, form, work, stipendio, id from mercatino where form = '2' order by data DESC ";
		  ...
		  my @row;
			...
			if($user ne $companyName){
						print"
								...
								<b>	$row[8] </b> - 	Nome: <i> $row[2] </i><br> Contatti: $row[6] ,  $row[5]<br> Stipendio: $row[9]
									</h3>
...
print"
		...
		<div class=\"col-lg-8 col-md-10 mx-auto\">
			<a name=\"people\"></a>
			<h1 class=\"post-title\">Cerca il dipendente per la tua azienda</h1></a><br>
			<hr class=\"style_shadow\">
";
 my $PG_COMMAND2="select DISTINCT data, message, name, uid, cv, email, telephone, form, work, stipendio, id from mercatino where form = '1' order by data DESC ";
	...
	while (@row2 = $sth2->fetchrow_array) {
						...
						print"
									<div class=\"post-preview\">
										<a href=\"#\">
									<h3 class=\"post-subtitle\">
								<b>	$row2[8] </b> - 	Nome: <i> $row2[2] </i><br> Contatti: $row2[6] ,  $row2[5]<br> Stipendio: $row2[9]
									</h3>
									<h4 class=\"post-subtitle\">
									Messaggio:	$row2[1]
									</h4>
