...
generateHTMLInputForm( "insert", $sid, $message_type, $date_of_loading1, $DL1, $date_of_loading2, $DL2, $pur_index, $PUR, $pup_index, $PUP, $dr_index, $DR, $dp_index, $DP, $veihcle_type, $VT, $arg_status, $arg_length, $arg_weight, $arg_notes, $arg_bay_for_coils, $arg_adr,  $arg_big_volume, "from_create"  );
