...
<!--===============================================================================================-->
  ...
  <body>
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('/mercatino/img/personale.jpg')">
	<a name="header"></a>
        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="site-heading">
              ...
              <span class="subheading">Sezione dedicata a chi cerca o offre lavoro</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-8 col-md-10 mx-auto">
			...
			<form id="mercatinoForm" name="mercatinoForm" action="/cgi-bin/insertMercatoQuick.pl" method="post" accept-charset="utf-8" enctype="multipart/form-data"  class="contact100-form validate-form container-contact100">
				<span class="contact100-form-title">
					...
					<input type="hidden" id="typology" name="typology" value ="2">
				</span>
...
my $dbh = DBI->connect("DBI:Pg:dbname=$database_name", "$db_username", "$db_pwd")
       or die $DBI::errstr;
  my $PG_COMMAND="select DISTINCT company, phone, email, message, data, id from mercato_quick where typology = '2' order by data DESC ";
