...
print "<p>Ciao $name_str, compila i dettagli qui sotto:  <input id=\"sid\" name=\"sid\" type=\"hidden\" value=\"";
...
print "<p>\nData Carico A:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type=\"text\"  data-polyfill=\"all\" id=\"date_of_loading1\" name=\"date_of_loading1\" placeholder=\"dd/mm/yyyy\" value=\"$date_of_loading1\" size=\"10\" $require_date_of_loading />\n</p>";
print "<p>\nData Carico B:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type=\"text\" data-polyfill=\"all\" id=\"date_of_loading2\" name=\"date_of_loading2\" placeholder=\"dd/mm/yyyy\" value=\"$date_of_loading2\" size=\"10\" />\n</p>";
